...
(function() {
    ...
    var loadPackage = function(metadata) {
        ...
        var PACKAGE_NAME = "asteroids.data";
        var REMOTE_PACKAGE_BASE = "asteroids.data";
        ...
        function runWithFS() {
            ...
            function processPackageData(arrayBuffer) {
                ...
                Module["removeRunDependency"]("datafile_asteroids.data")
            }
            Module["addRunDependency"]("datafile_asteroids.data");
    ...
    loadPackage({
        "files": [{
            "filename": "/assets/bruh.txt",
            "start": 0,
            "end": 3
        }],
        "remote_package_size": 3,
        "package_uuid": "1bcc655d-ba94-4446-85dd-69856b521880"
    })
})();
...
function getBinaryPromise() {
    if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
        if (typeof fetch === "function" && !isFileURI(wasmBinaryFile)) {
            return fetch("https://iapetus11.me/static/asteroids.wasm", {
...
var _initConfigDone = Module["_initConfigDone"] = createExportWrapper("initConfigDone");
